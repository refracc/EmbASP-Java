...
public class DatalogGrammarBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements DatalogGrammarVisitor<T> {
   ...
   */
  @Override
  public T visitOutput(DatalogGrammarParser.OutputContext ctx) {
   ...
   */
  @Override
  public T visitPredicate_atom(DatalogGrammarParser.Predicate_atomContext ctx) {
    return visitChildren(ctx);
  }
   ...
   */
  @Override
  public T visitTerm(DatalogGrammarParser.TermContext ctx) {
    return visitChildren(ctx);
  }
}