...
public class DLVParser extends Parser {
  ...
  public static class SimpleModelContext extends Answer_setContext {
    public SimpleModelContext(Answer_setContext ctx) {
      copyFrom(ctx);
    }
  ...
  public static class WeightedModelContext extends Answer_setContext {
    public WeightedModelContext(Answer_setContext ctx) {
      copyFrom(ctx);
    }
    ...
    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DLVParserVisitor)
        return ((DLVParserVisitor<? extends T>) visitor).visitWeightedModel(this);
      else return visitor.visitChildren(this);
    }
  }

  public static class NonGroundQueryContext extends Answer_setContext {
    public NonGroundQueryContext(Answer_setContext ctx) {
      copyFrom(ctx);
    }
    ...
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DLVParserVisitor)
        return ((DLVParserVisitor<? extends T>) visitor).visitNonGroundQuery(this);
      else return visitor.visitChildren(this);
    }
  }
