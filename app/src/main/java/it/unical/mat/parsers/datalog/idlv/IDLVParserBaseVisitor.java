...
public class IDLVParserBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements IDLVParserVisitor<T> {
   ...
   */
  @Override
  public T visitOutput(IDLVParser.OutputContext ctx) {
   ...
   */
  @Override
  public T visitMinimal_model(IDLVParser.Minimal_modelContext ctx) {
    return visitChildren(ctx);
  }
   ...
   */
  @Override
  public T visitPredicate_atom(IDLVParser.Predicate_atomContext ctx) {
    return visitChildren(ctx);
  }
   ...
   */
  @Override
  public T visitTerm(IDLVParser.TermContext ctx) {
    return visitChildren(ctx);
  }
}