...
public class DLVHEXParser extends Parser {
  ...
  public static class GroundQueryContext extends Answer_setContext {
    public GroundQueryContext(Answer_setContext ctx) {
      copyFrom(ctx);
    }
    ...
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DLVHEXParserVisitor)
        return ((DLVHEXParserVisitor<? extends T>) visitor).visitGroundQuery(this);
      else return visitor.visitChildren(this);
    }
  }

  public static class ModelContext extends Answer_setContext {
    public ModelContext(Answer_setContext ctx) {
      copyFrom(ctx);
    }
  ...
  public static class AtomsContext extends ParserRuleContext {
    ...
    public TerminalNode ANSWER_SET_BEGIN() {
      return getToken(DLVHEXParser.ANSWER_SET_BEGIN, 0);
    }

    public TerminalNode ANSWER_SET_END() {
  ...
  public static class LevelContext extends ParserRuleContext {
    ...
    public TerminalNode LEVEL_BEGIN() {
  ...
  public static class Predicate_atomContext extends ParserRuleContext {
    ...
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DLVHEXParserVisitor)
        return ((DLVHEXParserVisitor<? extends T>) visitor).visitPredicate_atom(this);
      else return visitor.visitChildren(this);
    }
  }
  ...
  public static class WitnessContext extends ParserRuleContext {
    ...
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DLVHEXParserVisitor)
        return ((DLVHEXParserVisitor<? extends T>) visitor).visitWitness(this);
      else return visitor.visitChildren(this);
    }
  }
}