...
public class ASPGrammarBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements ASPGrammarVisitor<T> {
   ...
   */
  @Override
  public T visitOutput(ASPGrammarParser.OutputContext ctx) {
   ...
   */
  @Override
  public T visitPredicate_atom(ASPGrammarParser.Predicate_atomContext ctx) {
    return visitChildren(ctx);
  }
   ...
   */
  @Override
  public T visitTerm(ASPGrammarParser.TermContext ctx) {
    return visitChildren(ctx);
  }
}