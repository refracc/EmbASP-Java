...
public class IDLVParser extends Parser {
  ...
  public static class Minimal_modelContext extends ParserRuleContext {
    ...
    public List<TerminalNode> ATOM_END() {
      return getTokens(IDLVParser.ATOM_END);
    }
    ...
    @Override
    public int getRuleIndex() {
      return RULE_minimal_model;
    }

    @Override
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof IDLVParserVisitor)
        return ((IDLVParserVisitor<? extends T>) visitor).visitMinimal_model(this);
      else return visitor.visitChildren(this);
    }
  }
  ...
  public static class Predicate_atomContext extends ParserRuleContext {
    ...
    public TerminalNode IDENTIFIER() {
      return getToken(IDLVParser.IDENTIFIER, 0);
    }

    public TerminalNode TERMS_BEGIN() {
      return getToken(IDLVParser.TERMS_BEGIN, 0);
    }
    ...
    public TerminalNode TERMS_END() {
      return getToken(IDLVParser.TERMS_END, 0);
    }

    public List<TerminalNode> COMMA() {
      return getTokens(IDLVParser.COMMA);
    }
    ...
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof IDLVParserVisitor)
        return ((IDLVParserVisitor<? extends T>) visitor).visitPredicate_atom(this);
      else return visitor.visitChildren(this);
    }
  }
  ...
  public static class TermContext extends ParserRuleContext {
    ...
    public TerminalNode INTEGER_CONSTANT() {
      return getToken(IDLVParser.INTEGER_CONSTANT, 0);
    }

    public TerminalNode STRING_CONSTANT() {
      return getToken(IDLVParser.STRING_CONSTANT, 0);
    }
