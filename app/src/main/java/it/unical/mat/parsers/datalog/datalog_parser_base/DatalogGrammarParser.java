...
public class DatalogGrammarParser extends Parser {
  ...
  public static class OutputContext extends ParserRuleContext {
    ...
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DatalogGrammarVisitor)
        return ((DatalogGrammarVisitor<? extends T>) visitor).visitOutput(this);
  ...
  public static class Predicate_atomContext extends ParserRuleContext {
    ...
    public TerminalNode IDENTIFIER() {
      return getToken(DatalogGrammarParser.IDENTIFIER, 0);
    }
    ...
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DatalogGrammarVisitor)
        return ((DatalogGrammarVisitor<? extends T>) visitor).visitPredicate_atom(this);
      else return visitor.visitChildren(this);
    }
  }
  ...
  public static class TermContext extends ParserRuleContext {
    ...
    public TerminalNode INTEGER() {
      return getToken(DatalogGrammarParser.INTEGER, 0);
    }

    public TerminalNode STRING() {
      return getToken(DatalogGrammarParser.STRING, 0);
    }
    ...
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof DatalogGrammarVisitor)
        return ((DatalogGrammarVisitor<? extends T>) visitor).visitTerm(this);
      else return visitor.visitChildren(this);
    }
  }
}