...
public class ClingoParser extends Parser {
  ...
  public static class Answer_setContext extends ParserRuleContext {
    ...
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof ClingoParserVisitor)
        return ((ClingoParserVisitor<? extends T>) visitor).visitAnswer_set(this);
  ...
  public static class Predicate_atomContext extends ParserRuleContext {
    ...
    public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
      if (visitor instanceof ClingoParserVisitor)
        return ((ClingoParserVisitor<? extends T>) visitor).visitPredicate_atom(this);
      else return visitor.visitChildren(this);
    }
  }
